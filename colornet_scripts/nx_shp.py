...
def write_shp(G, outdir):
                ...
                and key != 'ShpName'):
                  ...
                  # Field not in previous edges so add to dict
                        if type(data) in OGRTypes:
                            node_fields[key] = OGRTypes[type(data)]
                        else:
                        ...
                        node_attributes[key] = data
                    else:
                     # Field already exists, add data to dict for CreateLayer()
                        node_attributes[key] = data
        create_feature(g, nodes, node_attributes)
    try:
    ...
    edge_attributes = {}  # storage for attribute data (indexed by field names)
            ...
            if (key != 'Json' and key != 'Wkt' and key != 'Wkb'
                and key != 'ShpName'):
                  ...
                  # Field not in previous edges so add to dict
                        ...
                        # Store the data from new field to dict for CreateLayer()
                        edge_attributes[key] = data
                    else:
                     # Field already exists, add data to dict for CreateLayer()
                        edge_attributes[key] = data
        # Create the feature with, passing new attribute data
        create_feature(g, edges, edge_attributes)
